...
var _ reconcile.Reconciler = &ReconcileSummon{}

// ReconcileSummon reconciles a Summon object
type ReconcileSummon struct {
	client.Client
	scheme *runtime.Scheme
}

// Reconcile reads that state of the cluster for a Summon object and makes changes based on the state read
// and what is in the Summon.Spec
// TODO(user): Modify this Reconcile function to implement your Controller logic.  The scaffolding writes
// a Deployment as an example
// Automatically generate RBAC rules to allow the Controller to read and write Deployments
// +kubebuilder:rbac:groups=apps,resources=deployments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=summon.ridecell.io,resources=summons,verbs=get;list;watch;create;update;patch;delete
func (r *ReconcileSummon) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Summon instance
