...
var _ = Describe("PullSecret types", func() {
	...
	It("can create a PullSecret object", func() {
		c := helpers.Client
		key := types.NamespacedName{
			Name:      "foo",
			Namespace: helpers.Namespace,
		}
		created := &secretsv1beta1.PullSecret{
			ObjectMeta: metav1.ObjectMeta{
				Name:      "foo",
				Namespace: helpers.Namespace,
			}}
		fetched := &secretsv1beta1.PullSecret{}
	...
	It("can update a PullSecret object", func() {
		c := helpers.Client
